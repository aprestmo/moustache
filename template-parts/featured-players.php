...
/**
 * Template part for displaying featured players
 *
 * @package Moustache
 */
 ...
 */
function get_featured_players(): array
{
	return get_posts([
		'post_type'      => 'player',
		'post_status'    => 'publish',
 ...
 * @return void
 */
function display_player_image($image): void
{
	if ($image) : ?>
		<img class="u-img-round"
...
if ($players) : ?>
	<section class="o-grid o-section-md">
		<header class="o-grid__item u-1/1 u-text-center">
			<h2 class="c-players__title">
				<?php esc_html_e('Featured players', 'moustache'); ?>
			</h2>
		</header>
		...
		?>
			<div class="o-grid__item u-1/2 u-1/4@md u-soft-md u-text-center">
				<a class="c-players--featured" href="<?php echo esc_url(get_permalink()); ?>">
					<?php display_player_image(get_field('image')); ?>
				</a>
			</div>
		<?php
			wp_reset_postdata();
