...
define('POST_TYPE_FIXTURE', 'fixture');

add_action('init', function() {

	register_post_type( 'fixture' , array(
		'labels' => array(
			'name' => _x('Fixtures', 'post type general name', 'moustache'),
			'singular_name' => _x('Fixture', 'post type singular name', 'moustache'),
			'add_new' => _x('Add Fixture', 'post type singular', 'moustache'),
		...
		// register_post_type(POST_TYPE_FIXTURE, array(
...
// 	if ( $data['post_type'] == POST_TYPE_FIXTURE && isset( $postarr['acf']['field_5628878814866'] ) ) {
...
//  *
//  */
// add_action( 'save_post_' . POST_TYPE_FIXTURE, function( $post_ID, $post, $update ) {
