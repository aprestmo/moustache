...
define('POST_TYPE_CLUB', 'club');

add_action('init', function() {

	register_post_type( 'club' , array(
		'labels' => array(
			'name' => _x('Clubs', 'post type general name', 'moustache'),
			'singular_name' => _x('Club', 'post type singular name', 'moustache'),
			'add_new' => _x('Add Club', 'post type singular', 'moustache'),
		...
		// register_post_type(POST_TYPE_CLUB, array(
...
// 	if ( $data['post_type'] == POST_TYPE_CLUB && isset( $postarr['acf']['field_5628878814866'] ) ) {
...
//  *
//  */
// add_action( 'save_post_' . POST_TYPE_CLUB, function( $post_ID, $post, $update ) {
