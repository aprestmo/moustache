...
define('POST_TYPE_PLAYER', 'player');

add_action('init', function() {

	register_post_type( 'player' , array(
		'labels' => array(
			'name' => _x('Players', 'post type general name', 'moustache'),
			'singular_name' => _x('Player', 'post type singular name', 'moustache'),
			'add_new' => _x('Add Player', 'post type singular', 'moustache'),
		...
		// register_post_type(POST_TYPE_PLAYER, array(
...
// 	if ( $data['post_type'] == POST_TYPE_PLAYER && isset( $postarr['acf']['field_5628878814866'] ) ) {
...
//  *
//  */
// add_action( 'save_post_' . POST_TYPE_PLAYER, function( $post_ID, $post, $update ) {
