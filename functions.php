...
function fetch_standings_data(): array|false
{
    ...
    if (!is_season_2026_active()) {
        error_log('Standings: Season 2026 has ended, no longer fetching data');
        return false;
    }
...
function is_season_2026_active(): bool
{
    ...
    // Check if there are any future matches in the uteserie-2026 tournament
...
function standings_admin_page() {
    ...
    <div class="wrap">
        ...
        echo '<p>Season 2026 active: ' . ($is_active ? 'YES' : 'NO') . '</p>';
